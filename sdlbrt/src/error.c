...
#elif defined(RG350)
    prints("start Run|select Step|y Watch|L2+R2 Exit");
#else
...
#elif defined(RG350)
    if (key(13))debug=0; // step mode disabled
#else
